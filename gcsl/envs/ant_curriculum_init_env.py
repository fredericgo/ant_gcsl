...
class AntCurriculumInitEnv(AntGoalBase):
    ...
    def calc_reward(self, obs: torch.Tensor, goal: torch.Tensor):
        """
        ...
        reward = distance_reward #+ .2 * velocity_reward
        return reward
